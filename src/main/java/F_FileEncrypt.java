 ...
 * @author User
 */
public class F_FileEncrypt extends javax.swing.JFrame {
    JFileChooser fc;
    String fname;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("file Encryption");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       sql = "INSERT INTO fileencry VALUES('" + fname + "','" + jPasswordField1.getText() + "')";
