 ...
 * @author User
 */
public class B_SignUpPage extends javax.swing.JFrame {
...
//                        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(t2.getText() == ""){
            if(t3.getText() == ""){
                l1.setText("Enter The Credentials");
            }}
        else{
            try {
			
			sql = "INSERT INTO log VALUES('" + t1.getText() + "','" + t2.getText() + "', '" + t3.getText() + "')";
