 ...
 * @author User
 */
public class J_DeleteAccount extends javax.swing.JFrame {
...
//		String sql=String.format("DELETE FROM `javaframe` WHERE (`name` = '%s');", name);
       ...
       String sql=String.format("Delete from `log` where (`id`='%s' and `password`='%s');",s1,s2);
